...
module.exports = {
  name: 'restart',
  description: 'restart bot status (admin access only)',
  author: 'chrnyy',

  async execute(senderId, args, pageAccessToken, event) {
    const adminId = '100068434233610';
    ...
    try {
      await sendMessage(senderId, { text: '⚙️ MCv2 is restarting please wait..' }, pageAccessToken);
